...
export class MyApp {
  ...
  // rootPage: any = CategoryListComponent;
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Apperal Categories', component: ApperalCategoryListComponent },
      { title: 'Apperal Products', component: ApperalProductListComponent }
    ];
